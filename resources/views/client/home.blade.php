            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            <li><a href="/client_home" class="active">Home</a></li>
                            ...
                            <li  class="scroll-to-section" style="display:flex"><a href="/cart"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        fill="#000000" class="bi bi-cart-fill" viewBox="0 0 16 16">
                                        <path
            ...
            <div class="row g-5">
                <div class="col-lg-7">
                    <div class="section-title mb-4">
                        ...
                        <h1 class="display-5 mb-0">Unleash Your Artistic Alter Ego: Transform Your Images into
                            Caricature Masterpieces at ArtBros</h1>
                    </div>
                    <h4 class="text-body font-italic mb-4">Welcome to ArtBros, the ultimate web platform where we
                        transform your images into captivating caricatures. Our skilled team of top-notch artists and
                        graphic designers is dedicated to crafting these unique caricatures with unparalleled expertise
                        and creativity. Immerse yourself in the world of art and self-expression as we turn your moments
                        into cherished, one-of-a-kind masterpieces at ArtBros.</h4>

                </div>
                <div class="col-lg-5" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100 rounded wow zoomIn" data-wow-delay="0.9s"
                            src="assets/images/about.jpg" style="object-fit: cover;">
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="row">
                        <form action="/signup" method="POST" enctype="multipart/form-data" autocomplete="off"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control" id="validationPassword" minlength="8"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control" id="validationConfirmPassword"
                                    minlength="8" name="confirmPass" value required>
                                <div class="progress" style="height: 5px;">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" name="btnLogin" value="yes"
                        style="color:white !important;">Login</button>
