                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li class="scroll-to-section"><a href="/payments" class="active">Payments</a></li>
            ...
            <div class="row g-5">
                <div class="col-lg-12">
                    <div class="section-title mb-4">
                        <h5 class="position-relative d-inline-block text-primary text-uppercase">Payments</h5>
                        <h1 class="display-5 mb-0">Payment Methods</h1>
                    </div>
