...
<body>
              ...
              0px; bottom: 0px;">
                        <div class="simplebar-content-wrapper" tabindex="0" role="region"
                            ...
                            <div class="simplebar-content" style="padding: 0px;">
                                ...
                                <li class="nav-item"><a class="nav-link active" href="/artist_projects">
                        ...
                        <div class="dropdown-menu dropdown-menu-end pt-0">
                            ...
                            <div class="dropdown-header bg-light py-2">
                                ...
                                <svg class="icon me-2">
                                    ...
                                    class="badge badge-sm bg-primary ms-2">{{ $count }}</span></a>
            ...
            <div class="container-lg">
                <div class="row">
                    <div class="col-sm-6 col-lg-3">
                        <a data-coreui-toggle="modal" data-coreui-target="#addProjectModal"
                            style="text-decoration: none; cursor:pointer;">
                            <div class="card mb-4 text-white bg-primary" style="height:165px;">
                                <div class="card-body pb-0" style="background-color: #0095a0 !important;">
                                    <div>
                                        <center>
                                            <svg style="margin-top: 10px;" fill="#FFFFFF" width="60"
                                                height="60" viewBox="0 0 32 32" version="1.1"
                                            ...
                                            <div class="fs-5 fw-semibold" style="margin-top: 5px;">Add Project</div>
                                        </center>
                    ...
                    @foreach ($projects as $item)
                        <div class="col-sm-6 col-lg-3">
                            <a href="/artist_project_detail?id={{ $item['projectID'] }}"
                                style="text-decoration: none; cursor: pointer;" target="_blank">
                                <div class="card mb-4 text-white bg-primary" style="height:165px;">
                                    <div class="card-body pb-0 d-flex justify-content-between align-items-start"
                                        style="background-color: #858585 !important;">
                                        <div>
                                            <div class="fs-4 fw-semibold">{{ $item['projectName'] }} </div>
                                            <div>{{ $item['status'] }}</div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <form action="/artist_projects" method="POST" enctype="multipart/form-data"
                            autocomplete="off">
                            @csrf
                            <center>
                                <div class="form-group">
                                    <input required class="form-control" type="text" name="projectName"
                                        id="un" placeholder="Project Name">
                                </div>
                            </center>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" name="btnCreateProject" value="yes"
    ...
    @if (session()->pull('projectNameExist'))
        <script>
            setTimeout(() => {
                Swal.fire({
                    position: 'center',
                    icon: 'warning',
                    title: 'Project Name Already Exist, Please Try Again Later',
                    showConfirmButton: true,
                    timer: 800
                });
            }, 500);
        </script>
        {{ session()->forget('projectNameExist') }}
    @endif
    @if (session()->pull('errorAddProject'))
        <script>
            setTimeout(() => {
                Swal.fire({
                    position: 'center',
                    icon: 'warning',
                    title: 'Failed To Add Project, Please Try Again Later',
                    showConfirmButton: true,
                    timer: 800
                });
            }, 500);
        </script>
        {{ session()->forget('errorAddProject') }}
    @endif

    @if (session()->pull('projectNotFound'))
        <script>
            setTimeout(() => {
                Swal.fire({
                    position: 'center',
        ...
        {{ session()->forget('projectNotFound') }}
    @endif
    @if (session()->pull('successDeleteProject'))
        <script>
            setTimeout(() => {
                Swal.fire({
                    position: 'center',
        ...
        {{ session()->forget('successDeleteProject') }}
    @endif
    @if (session()->pull('successAddProject'))
        <script>
            setTimeout(() => {
                Swal.fire({
                    position: 'center',
        ...
        {{ session()->forget('successAddProject') }}
    @endif
</body>
