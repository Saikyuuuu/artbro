...
<body>
              ...
              0px; bottom: 0px;">
                        <div class="simplebar-content-wrapper" tabindex="0" role="region"
                            ...
                            <div class="simplebar-content" style="padding: 0px;">
                                ...
                                <li class="nav-item"><a class="nav-link active" href="/admin_users">
                                        <svg class="nav-icon" xmlns="http://www.w3.org/2000/svg" width="16"
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                <button class="btn btn-primary" data-coreui-toggle="modal"
                                    data-coreui-target="#signUpModal">Add
                                    User</button>
                            </div>
                            <div class="card-header">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button class="btn btn-success" style="color:white"
                                                                data-coreui-target="#viewUserModal{{ $item->userID }}"
                                                                data-coreui-toggle="modal">View/Edit</button>
                                                            <div class="modal fade "
                                                                id="viewUserModal{{ $item->userID }}" tabindex="-1"
                                                                role="dialog"
                                                                aria-labelledby="viewUserModalLabel{{ $item->userID }}"
                                                                aria-hidden="true">
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title"
                                                                                id="viewUserModalLabel{{ $item->userID }}">
                                                                                View/Edit User</h5>
                                                                        </div>
                                                                        <div class="modal-body">
                                                                            <div class="row">
                                                                                <form
                                                                                    action="{{ route('admin_users.update', ['admin_user' => $item->userID]) }}"
                                                                                    method="POST"
                                                                                    ...
                                                                                    <center>
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            <label for="birthDate"
                                                                                                class="for"
                                                                                                style="float:left;margin-bottom: 10px;"><b>Birth
                                                                                                    Date</b></label>
                                                                                            <input required
                                                                                                type="date"
                                                                                                name="birthDate"
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            <label for="userType"
                                                                                                style="float: left;margin-bottom: 10px;"><b>User
                                                                                                    Type:</b></label>
                                                                                            <select
                                                                                                class="form-control"
                                                                                                required
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <button class="btn btn-warning"
                                                                                style="color:white;"
                                                                                data-coreui-dismiss="modal">Send Reset
                                                                                Password</button>
                                                                            <button type="submit"
                                                                                class="btn btn-primary"
                                                                                name="btnAdminEditUser"
                                                                                value="yes">Update
                                                                                User</button>
                                                                        </div>
                                                                        </form>
                                                            ...
                                                            <button class="btn btn-danger" style="color:white"
                                                                data-coreui-target="#deleteUserModal{{ $item->userID }}"
                                                                data-coreui-toggle="modal">Delete</button>
                                                            <div class="modal fade "
                                                                id="deleteUserModal{{ $item->userID }}"
                                                                ...
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <div class="row">
                                                                                <form
                                                                                    action="{{ route('admin_users.destroy', ['admin_user' => $item->userID]) }}"
                                                                                    method="POST"
                                                                                    enctype="multipart/form-data"
                                                                                    autocomplete="off">
                                                                                    @method('delete')
                                        ...
                                        <div class="pagination">
                                            <ul class="pagination">
                                                @for ($i = 1; $i <= $allUsers->lastPage(); $i++)
                                                    <li class="page-item ">
                                                        <a class="page-link {{ $allUsers->currentPage() == $i ? 'active' : '' }}"
                                                            href="{{ $allUsers->url($i) }}">{{ $i }}</a>
                                                    </li>
                                                @endfor
                                            </ul>
    ...
    <div class="modal fade " id="signUpModal" tabindex="-1" role="dialog" aria-labelledby="signUpModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="signUpModalLabel">Create User</h5>
                </div>
                <div class="modal-body">
                    <div class="row">
                            ...
                            <center>
                                ...
                                <div class="form-group">
                                    <label for="birthDate" class="for"
                                        style="float:left;margin-bottom: 10px;"><b>Birth Date</b></label>
                                ...
                                <br>
                                <div class="form-group">
                                    <label for="userType" style="float: left;margin-bottom: 10px;"><b>User
                                            Type:</b></label>
                                    <select class="form-control" required name="userType" id="">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" style="color:white !important;"
                        data-coreui-dismiss="modal">Close</button>
                    <button type="submit" class="btn btn-primary" name="btnAdminSignup" value="yes">Create
                        User</button>
                </div>
                </form>
            </div>
    ...
    @if (session()->pull('successDeletedUser'))
        <script>
            setTimeout(() => {
                Swal.fire({
                    position: 'center',
        ...
        {{ session()->forget('successDeletedUser') }}
    @endif
    ...
    @if (session()->pull('successAdminCreate'))
        <script>
            setTimeout(() => {
                Swal.fire({
                    position: 'center',
        ...
        {{ session()->forget('successAdminCreate') }}
    @endif

    @if (session()->pull('errorAdminCreate'))
        <script>
            setTimeout(() => {
                Swal.fire({
                    position: 'center',
        ...
        {{ session()->forget('errorAdminCreate') }}
    @endif
