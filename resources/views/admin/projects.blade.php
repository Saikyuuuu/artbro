...
<body>
              ...
              0px; bottom: 0px;">
                        <div class="simplebar-content-wrapper" tabindex="0" role="region"
                            ...
                            <div class="simplebar-content" style="padding: 0px;">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="/admin_projects">
        ...
        <div class="body flex-grow-1 px-3">
            <div class="container-lg">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card mb-4">
                            <div class="card-header blueHeader">

                            </div>
                            <div class="card-body">
                                <form action="/admin_projects" method="get">
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control"
                                            placeholder="Search Project's Name" aria-label="Recipient's username"
                                    ...
                                    <table class="table border mb-0">
                                        <thead class="table-light fw-semibold">
                                            <tr class="align-middle">
                                                ...
                                                <th>Status</th>
                                                <th class="text-center">Project Created</th>
                                                <th>Action</th>
                                        ...
                                        <tbody>
                                            @foreach ($projects as $item)
                                                <tr class="align-middle">
                                                    ...
                                                    <td>
                                                        @if ($item->notes == 'for show')
                                                            <button
                                                                onclick="triggerShow({{ $item->projectID }},'{{ $projectFileData[$item->projectID] }}')"
                                                                class="btn" title="Show As Featured">
                                        ...
                                        <div class="pagination">
                                            <ul class="pagination">
                                                @for ($i = 1; $i <= $projects->lastPage(); $i++)
                                                    <li class="page-item ">
                                                        <a class="page-link {{ $projects->currentPage() == $i ? 'active' : '' }}"
    ...
    <div class="modal fade " id="showAsFeaturedModal" tabindex="-1" role="dialog"
        aria-labelledby="showAsFeaturedModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="showAsFeaturedModalLabel">Show Item As Featured</h5>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <form id="showFeaturedForm" action="" method="POST" enctype="multipart/form-data"
                            autocomplete="off">
                            @csrf
                            <center>
                                <div class="form-group">
                                    Do You Want To Show This Project In Featured Items?
                                </div>
                                <br>
                                <div class="form-group">
